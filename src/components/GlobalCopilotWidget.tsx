    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-10 right-6 z-[9999] w-36 h-36 rounded-full shadow-lg hover:scale-105 transition-transform overflow-hidden border-2"
      ...
      {isOpen && (
        <div
          className={`fixed bottom-10 right-6 z-[9999] w-[340px] rounded-2xl shadow-2xl flex flex-col overflow-hidden transition-all duration-200 ${isMinimized ? "h-[56px]" : "h-[480px]"}`}
